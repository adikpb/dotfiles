...
- Read the oh-my-opencode-slim.json understand how it is configured
- Go through each agent prompt to understand what model use for each agent
- Generate an oh-my-opencode-slim.json that is optimal, try not to use models with bad tool calling/usage capabilities
