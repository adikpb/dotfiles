...
description: Use to research and validate vague project or business idea.
version: 1.0.0
author: Scampi
license: MIT
metadata:
...
**For creative/novelty domains** (developer tools, consumer apps, content products), use **competitive landscape gap analysis** to find fresh territory: gather projects, categorize them by comedy/differentiation mechanism, assess saturation per category, identify gaps, and generate concepts from gaps. See `references/competitive-landscape-analysis.md` for the methodology and a worked example.
