...
| Verified model profiles (measured on this machine) | `references/model-profiles.md` |
| GGUF load settings reference (memory impact, GGUF vs MLX applicability) | `references/gguf-load-settings.md` |
